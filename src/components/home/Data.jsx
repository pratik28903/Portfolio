...
const Data = () => {
  ...
  return (
    <div className="home_data">
      ...
      <h1 className="home_title">I'am</h1>
      <h1 className="home_title_name">
        <b>Pratik Ostwal</b>
        <svg
          width="36"
          height="36"
      ...
      <div className="home_title_typewritereffect">
        <TypeWriterEffect
          textStyle={{
            color: "black",
            fontSize: "1.5rem",
      ...
      <br />
      <button onClick={handleClickOpen} className="button button--flex">
        See My Resume
        <svg
